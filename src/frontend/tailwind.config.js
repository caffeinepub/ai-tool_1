  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        brand: {
          orange: "oklch(0.75 0.155 50)",
          "orange-hover": "oklch(0.70 0.160 48)",
        },
        navy: {
          deep: "oklch(0.13 0.025 240)",
          mid: "oklch(0.17 0.028 237)",
          panel: "oklch(0.175 0.025 235)",
          surface: "oklch(0.20 0.030 238)",
          border: "oklch(0.27 0.035 230)",
        },
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        navy: "0 4px 24px rgba(0,0,0,0.40)",
        "navy-lg": "0 8px 48px rgba(0,0,0,0.55)",
        orange: "0 0 24px oklch(0.75 0.155 50 / 0.25)",
      },
      keyframes: {
